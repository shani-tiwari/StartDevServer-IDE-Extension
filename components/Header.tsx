...
import Link from "next/link";
 ...
 export default function Header(){
    return (
      <header className="w-fit h-[56vh] md:h-[72vh] flex flex-col items-center justify-end "> 

        <div className="badge opacity-80 flex items-center justify-center gap-3 bg-stone-100/80 rounded-full px-8 py-1 mb-3 text-sm border border-stone-400/80 shadow-md shadow-stone-400/20">
        ...
        <p className="w-[40%] text-xs md:text-base text-center mb-5 tracking-wide">Run your React/Next JS Projects in a click.</p>
