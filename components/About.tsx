...
export default function About(){
  ...
  return (
    <section className=" max-w-275 px-4 w-full mx-auto bg-black/1 py-10 rounded-xl md:my-8 flex flex-col font-sans border-b-2 border-b-stone-300">
            ...
            <div className="flex flex-col justify-center gap-7 mx-auto w-fit">
                {
                    steps.map((step, i) => 
                        <div key={i} className={`flex items-center gap-4`}>
                            <span className="size-2.5 bg-stone-400  rounded-full  border border-stone-300/70"/>
